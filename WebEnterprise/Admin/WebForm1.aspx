<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="WebEnterprise.Admin.WebForm1" %>
   ...
   <div>
       ...
       <div>
        ...
        <asp:Panel ID="Panel3" runat="server">
           ...
           SelectCommand="SELECT DISTINCT * FROM [AspNetUsers] WHERE ([deptName] = @deptName)"
